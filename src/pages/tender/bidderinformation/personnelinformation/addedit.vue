  ...
  <div class="list-container">
    ...
    <div class="box-container ">
      <el-tabs v-model="selected">
        ...
        <el-tab-pane @click="tabPage('职业资格信息')" label="职业资格信息" name="职业资格信息"></el-tab-pane>
        <el-tab-pane @click="tabPage('业绩信息')" label="业绩信息" name="业绩信息"></el-tab-pane>
        <el-tab-pane @click="tabPage('奖惩信息')" label="奖惩信息" name="奖惩信息"></el-tab-pane>
      </el-tabs>
      <basic-info :params="params" v-if="'基本信息' === selected"></basic-info>
      <occupation @setPersonnelId="setPersonnelId" :params="params" v-if="'职业资格信息' === selected"></occupation>
      <results @setPersonnelId="setPersonnelId" :params="params" v-if="'业绩信息' === selected"></results>
...
<script>
// 投标人信息库
import basicInfo from 'src/pages/tender/bidderinformation/personnelinformation/basicinfo';
import occupation from 'src/pages/tender/bidderinformation/personnelinformation/occupationalqualificationinformation';
import rewardsPunish from 'src/pages/tender/bidderinformation/personnelinformation/rewardspunishments';
import results from 'src/pages/tender/bidderinformation/personnelinformation/results';
export default {
