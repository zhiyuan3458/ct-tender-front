          ...
          >
            <template slot-scope="scope">
              <div style="white-space: nowrap;">
                ...
                <el-button class="el-btn-edit" type="text" style="color: #409EFF;" size="small" @click="handleAdd(scope.row.id, 'edit')">编辑</el-button>
...
export default {
  name: '/tender/bidderinformation/personnelinformation',
  computed: {
    /**
     * @description 头部样式
     * @author lvzhiyuan
  ...
  methods: {
    ...
    handleAdd (id, operation) {
      this.$router.push(`/tender/bidderinformation/personnelinformation/addedit?personnelId=${id}&operation=${operation}`);
    },
    /**
       * @description
       * @author wenruihuan
