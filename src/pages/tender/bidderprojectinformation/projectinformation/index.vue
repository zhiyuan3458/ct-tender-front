          ...
          <div>
            <el-form :inline="true" class="demo-form-inline" label-width="110px">
              <el-form-item label="项目名称">
                <el-input clearable v-model="name" placeholder=""></el-input>
              </el-form-item>
              <el-form-item label="项目编号">
                <el-input clearable v-model="code" placeholder=""></el-input>
              </el-form-item>
              <el-form-item label="项目业主单位">
                <el-input clearable v-model="ownerName" placeholder=""></el-input>
              </el-form-item>
            </el-form>
...
import { listJson } from 'src/api/tender/bidderprojectinformation';
export default {
  name: '/tender/bidderprojectinformation/projectinformation',
  data () {
    return {
      name: '',
      code: '',
