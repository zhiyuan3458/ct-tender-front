      ...
      <div class="box-container nav-container">
        <div class="box-header address-header">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>中标通知书审核</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </div>
...
import { winbidbulletinList } from 'src/api/tender/projectmanagement';
export default {
  name: '/tender/projectmanagement/notificationacceptance',
  data () {
    return {
      searchData: {
        tenderBatchName: '',
  ...
  methods: {
    ...
    async getList () {
      ...
      const { data } = await winbidbulletinList(params);
      try {
