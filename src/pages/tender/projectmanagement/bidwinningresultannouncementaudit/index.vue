      ...
      <div class="box-container nav-container">
        <div class="box-header address-header">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>中标结果公告审核</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </div>
...
import { winbidnoticeJson } from 'src/api/tender/projectmanagement';
export default {
  name: '/tender/projectmanagement/bidwinningresultannouncementaudit',
  data () {
    return {
      searchData: {
        tenderBatchName: '',
  ...
  methods: {
    ...
    async getList () {
      ...
      const { data } = await winbidnoticeJson(params);
      try {
