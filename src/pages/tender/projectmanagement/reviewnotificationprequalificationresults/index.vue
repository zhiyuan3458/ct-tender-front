      ...
      <div class="box-container nav-container">
        <div class="box-header address-header">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>资格预审结果通知书审核</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </div>
...
import { prequalificationList } from 'src/api/tender/projectmanagement';
export default {
  name: '/tender/projectmanagement/reviewnotificationprequalificationresults',
  data () {
    return {
      searchData: {
        tenderBatchName: '',
  ...
  methods: {
    ...
    async getList () {
      ...
      const { data } = await prequalificationList(params);
      try {
