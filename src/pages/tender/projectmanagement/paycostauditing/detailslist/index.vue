          ...
          <div>
            <el-form :inline="true" class="demo-form-inline" label-width="110px" ref="searchTable">
              ...
              <el-form-item class="el-form-item-right" label=" ">
                ...
                <el-button @click="$router.go(-1)" type="success" icon="el-icon-back">返回</el-button>
              </el-form-item>
            </el-form>
...
import { tenderapplypayListPayJson } from 'src/api/tender/projectmanagement';
export default {
  ...
  created () {
    this.searchData.tenderBatchInfoId = this.$route.query.tenderBatchInfoId;
    this.getList();
  },
  mounted () {
    setTimeout(() => {
  ...
  methods: {
    ...
    async getList () {
      ...
      const { data } = await tenderapplypayListPayJson(params);
      try {
