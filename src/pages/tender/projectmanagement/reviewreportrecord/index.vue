      ...
      <div class="box-container nav-container">
        <div class="box-header address-header">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>评标报告备案</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </div>
...
import { listAuditJson } from 'src/api/tender/projectmanagement/reviewreportrecord';

export default {
  name: '/tender/projectmanagement/reviewreportrecord',
  data () {
    return {
      searchParams: {
        projectName: '',
