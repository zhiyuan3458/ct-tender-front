      ...
      <div class="box-container nav-container">
        <div class="box-header address-header">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>履约审核</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </div>
        ...
        <div class="box-body search-box-body">
          <div>
            <el-form :inline="true" class="demo-form-inline" label-width="110px" ref="searchTable">
              <el-form-item label="项目名称" v-if="isType !== 'tender'">
                <el-input clearable v-model="searchData.projectName" placeholder=""></el-input>
              </el-form-item>
              <el-form-item label="项目编号" v-if="isType !== 'tender'">
...
import { performancereauditListJson } from 'src/api/tender/projectmanagement';
export default {
  name: '/tender/projectmanagement/performancereaudit',
  data () {
    return {
      searchData: {
        projectName: '',
  ...
  methods: {
    ...
    async getList () {
      ...
      const { data } = await performancereauditListJson(params);
      try {
        ...
        console.log(`tender-projectmanagement-performancereaudit error: ${e}`);
      }
    },
    handleSubmit () {
      this.getList();
