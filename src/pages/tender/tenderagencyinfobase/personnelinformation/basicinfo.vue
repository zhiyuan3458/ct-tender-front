    ...
    <div class="table">
      <el-form :model="formData" ref="ctForm" label-width="200px">
        ...
        <el-row class="row-bg">
          ...
          <el-col :span="12">
            <el-form-item label="从事本专业起始日期" prop="startWorkDate">
              <el-date-picker
                :disabled="disabled"
        ...
        <el-row class="row-bg">
          <el-col :span="12">
            <el-form-item label="第一学历" prop="firstDegree" :rules="[$validate.Required]">
              <dictionary-comp
                :rules="[$validate.Required]"
          ...
          <el-col :span="12">
            <el-form-item label="第一学历毕业院校" prop="graduateSchoolOfFirstDegree" :rules="[$validate.Required]">
              <el-input maxlength="30" v-model="formData.graduateSchoolOfFirstDegree" :disabled="disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row class="row-bg">
        ...
        <el-row class="row-bg">
          ...
          <el-col :span="12">
            <el-form-item label="最高学历毕业院校" prop="graduateSchoolOfHighestDegree">
        ...
        <el-row class="row-bg">
          <el-col :span="12">
            <el-form-item label="最高学历所学专业" prop="specialtyOfHighestDegree">
              <el-input maxlength="30" v-model="formData.specialtyOfHighestDegree" :disabled="disabled"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="最高学历毕业时间" prop="graduateDateOfHighestDegree">
              <el-date-picker
                :rules="[$validate.Required]"
                :disabled="disabled"
