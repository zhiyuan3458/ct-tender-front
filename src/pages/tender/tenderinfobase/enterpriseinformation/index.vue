...
<script>
// 投标代理信息库
import basicInfo from 'src/pages/tender/tenderinfobase/enterpriseinformation/basicinfo';
import rewardsPunish from 'src/pages/tender/tenderinfobase/enterpriseinformation/rewardspunishments';
import history from 'src/pages/tender/tenderinfobase/enterpriseinformation/history';
export default {
  name: '/tender/tenderinfobase/enterpriseinformation',
  data () {
    return {
      formData: {},
      params: {
