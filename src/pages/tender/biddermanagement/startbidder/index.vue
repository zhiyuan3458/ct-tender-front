      ...
      <div class="box-container nav-container">
        <div class="box-header address-header">
          <el-breadcrumb separator="/">
            ...
            <el-breadcrumb-item>开始投标</el-breadcrumb-item>
          </el-breadcrumb>
        </div>
      </div>
...
import { bidderListJson } from 'src/api/tender/biddermanagement/startbidder';
export default {
  name: 'tender/biddermanagement/startbidder',
  components: {
    commonTable
  },
  mixins: [
  ...
  methods: {
    ...
    handleAudit (obj) {
      const { row } = obj;
      window.open(`/tender/biddermanagement/checkqualificationofprequalification/sendbid/issueprequalificationnotice?tenderBatchInfoId=${row.id}`, '_blank');
    },
    /**
    ...
    handleTender (obj) {
      const { row } = obj;
      window.open(`/tender/biddermanagement/tenderofprequalification/sendbid/tenderfilerecord?tenderBatchInfoId=${row.id}`, '_blank');
    },
    /**
    ...
    async getList () {
      ...
      try {
        ...
        console.log(`tender-biddermanagement-startbidder-getList error: ${e}`);
      }
    },
