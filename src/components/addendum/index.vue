  ...
  <div class="list-container">
    ...
    <div class="box-container table-container">
      <div class="box-header">
        ...
        <el-button class="add-btn" type="success" size="mini" @click="handleAdd" icon="el-icon-circle-plus-outline" v-if="state === '2'">新增</el-button>
      </div>
      <template>
        <common-table
          ref="table"
    ...
    <add-edit v-if="isDialog" :role="role" :show-type="addEditType" :tenderBatchInfoId="tenderBatchInfoId" :type="type" ref="addEdit" @return="handleReturn"></add-edit>
  </div>
</template>
<script>
...
import { listJson } from 'src/api/tender/biddermanagement/addendum';
